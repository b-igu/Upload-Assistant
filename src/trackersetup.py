...
from src.trackers.ANMT import ANMT
...
tracker_class_map = {
    'ACM': ACM, 'AITHER': AITHER, 'AL': AL, 'ANMT':ANMT, 'ANT': ANT, 'AR': AR, 'ASC': ASC, 'AZ': AZ, 'BHD': BHD, 'BHDTV': BHDTV, 'BJS': BJS, 'BLU': BLU, 'BT': BT, 'CBR': CBR,
...
http_trackers = {
    'ANMT', 'AR', 'ASC', 'AZ', 'BJS', 'BT', 'CZ', 'FF', 'FL', 'HDB', 'HDS', 'HDT', 'MTV', 'PHD', 'PTER', 'PTS', 'TTG'
}
